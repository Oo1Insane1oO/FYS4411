...
\label{sub:without_jastrow}
    As for the calculations without the Jastrow factor the energies look good.
    We have no ground to compare with the energies with Jastrow factor, however
    we expect the energies to be lower when the Jastrow factor is included. \\
