    ...
    The final expression for the elements in the Hessen matrix is thus
        \begin{equation}
            \begin{aligned}
                ...
                \frac{1}{2}\ecp{E_L}\ecp{R^2} - 2\ecp{E_LR}\ecp{R} +
                \ecp{E_L}\ecp{R}^2\right) -
                \omega\left(\ecp{\prd{\alpha}[E_L]R} + 2\ecp{R}\right) \\
                \prd{\beta}[\ecp{E_L}][2] &= 4\left(\ecp{E_Lh^2}
                + \ecp{E_Ll} - 2\ecp{E_Lh}\ecp{l} + \ecp{E_L}\left(\ecp{h}^2 -
                \ecp{h^2} - \ecp{l} - \ecp{h}\right)\right) -
                2\ecp{\prd{\beta}[E_L]h} 
            \end{aligned}
