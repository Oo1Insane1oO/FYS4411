...
\newcommand{\gsum}{\sum\limits_{i\neq j} \frac{a}{\left(\beta + \frac{1}{r_{ij}}\right)}}
    ...
    The second derivative is then
        \begin{align}
            ...
            \ecp{\frac{1}{\abs{\psi_T}}\psialphder}\prd{\alpha}[\ecp{E_L}]\right)
    ...
    We solve the derivatives individually
        \begin{align}
            ...
            \ecp{\frac{1}{\abs{\psi_T}}\prd{\alpha}[E_L]\psialphder}
            -2\ecp{\frac{E_L}{\abs{\psi_T}}\psialphder}
    ...
    expectation value of the local energy with respect to $\alpha$ is
        \begin{equation}
            \prd{\alpha}[\ecp{E_L}][2] = 2\left(1-\ecp{E_L}\right)
            \ecp{\frac{E_L}{\abs{\psi_T}^2}\left(\psialphder\right)^2} -
            8\ecp{\frac{E_L}{\abs{\psi_T}}\psialphder}
            \ecp{\frac{1}{\abs{\psi_T}}\psialphder}
            -2\ecp{E_L}\ecp{\frac{1}{\abs{\psi_T}}\psialphsecder} +
            8\ecp{E_L}\ecp{\frac{1}{\abs{\psi_T}}\psialphder}^2
    ...
    replaced by $\beta$).
        \begin{equation}
            ...
            \ecp{\frac{E_L}{\abs{\psi_T}^2}\left(\psibetder\right)^2} -
            8\ecp{\frac{E_L}{\abs{\psi_T}}\psibetder}
            \ecp{\frac{1}{\abs{\psi_T}}\psibetder}
            -2\ecp{E_L}\ecp{\frac{1}{\abs{\psi_T}}\psibetsecder} +
            8\ecp{E_L}\ecp{\frac{1}{\abs{\psi_T}}\psibetder}^2
    ...
    The final expression for the elements in the Hessen matrix is thus
        \begin{equation}
            \begin{aligned}
                ...
                2\ecp{h}\left(\ecp{E_L}\left(2 + \omega\left(\ecp{R}\right) -
                \ecp{E_LR}\right)\right)
            \end{aligned}
        \end{equation}
    where 
        \begin{equation}
