...
\label{ssub:Two Electron Case}
    ...
    giving
        \begin{align}
            ...
            \frac{2a(x_1-x_2)}{\beta r_{12} + 1}\right] + \left(-2\alpha\omega
            x_1 + \frac{2a(x_1-x_2)}{\beta r_{12} + 1}\right)\mprd{x_1}[\psi_T]
            \nonumber \\ 
            &= \left[-2\alpha\omega + \frac{2a}{\beta r_{12} + 1} -
            \frac{8a\beta(x_1-x_2)^2}{r_{12}(\beta r_{12} + 1)^2} +
            \left(-2\alpha\omega x_1 + \frac{2a(x_1-x_2)}{\beta r_{12} +
            1}\right)^2\right]\psi_T
            \label{eq:derx1first5}
        \end{align}
    The second derivative with respect to $y_1$ yields with a similar
    derivation
        \begin{equation}
            \mprd{y_1}[\psi_T][2] = \left[-2\alpha\omega + \frac{2a}{\beta
            r_{12} + 1} - \frac{8a\beta (y_1-y_2)^2}{r_{12}(\beta r_{12} +
            1)^2} + \left(-2\alpha\omega y_1 + \frac{2a(y_1-y_2)}{\beta r_{12}
            + 1}\right)^2\right]\psi_T
            \label{eq:dery1}
        \end{equation}
    ...
    differentiating $r_{12}$. This gives
        \begin{equation}
            \mprd{x_2}[\psi_T][2] = \left[-2\alpha\omega + \frac{2a}{\beta
            r_{12} + 1} + \frac{8a\beta (x_1-x_2)^2}{r_{12}(\beta r_{12} +
            1)^2} + \left(2\alpha\omega x_2 + \frac{2a(x_1-x_2)}{\beta r_{12} +
            1}\right)^2\right]\psi_T
            \label{eq:derx2}
        \end{equation}
    and
        \begin{equation}
            \mprd{y_2}[\psi_T][2] = \left[-2\alpha\omega + \frac{2a}{\beta
            r_{12} + 1} + \frac{8a\beta (y_1-y_2)^2}{r_{12}(\beta r_{12} +
            1)^2} + \left(2\alpha\omega y_2 + \frac{2a(y_1-y_2)}{\beta r_{12} +
            1}\right)^2\right]\psi_T
            \label{eq:dery2}
        \end{equation}
    gathering \Autoref{eq:derx1first5,eq:dery1,eq:derx2,eq:dery2} we get
        \begin{align}
            ...
            &= \left[-4\alpha\omega + \frac{4a}{\beta r_{12} + 1} +
            2\alpha^2\omega^2\left(r^2_1 + r^2_2\right) - \frac{2a\alpha\omega
            r^2_{12}}{\beta r_{12} + 1} + \frac{2a^2r^2_{12}}{(\beta r_{12} +
            1)^2}\right]\psi_T
            \label{eq:derLast}
        \end{align}
