...
\newcommand{\gsum}{\sum\limits_{i\neq j} \frac{a}{\left(\beta + \frac{1}{r_{ij}}\right)}}
    ...
    Solving the derivative terms
        \begin{align}
            ...
            \abs{\psi_T}\prd{\alpha}[\psi_T]\prd{\beta}[E_L]}{\psinorm} -
    ...
    theorem\cite{linalgDavid}) is
        \begin{align}
            \frac{\prtl^2\ecp{E_L}}{\prtl\alpha\prtl\beta} &= 2\left(1-\ecp{E_L}\right) \ecp{\frac{1}{\abs{\psi_T}^2} \prd{\alpha}[\abs{\psi_T}] \prd{\beta}[\abs{\psi_T}]} - 8
        \end{align}
