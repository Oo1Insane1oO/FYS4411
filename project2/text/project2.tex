...
\newcommand{\prd}[3]{\frac{\prtl^{#3}#1}{\prtl {#2}^{#3}}} %reduce length of partial (less to write)
\newcommand{\prds}[2]{\frac{\prtl #1}{\prtl {#2}}} %reduce length of partial (less to write)
