...
\newcommand{\prodsecrule}[2]{{#2} \nabla^2_k {#1} + {#1} \nabla^2_k {#2}}
    ...
    relation given in \Autoref{eq:hermiteReq} for $H_n(s)$ gives
        \begin{align}
            ...
            \nonumber \\
            &= \omega\left[\frac{n}{s}(4(n+1)-\alpha(\alpha s^2-1))\me^{s^2} +
            2\alpha s(\alpha s^2-4n-5)\right]H_n(s)e(s) \nonumber \\
            \prd{x_k}[][2]\left(H_{n_{x_k}}\left(\sqrt{\omega}x_k\right)
            e(x_k)\right) &= \left[\frac{n_{x_k}\sqrt{\omega}}{x_k}
            \left(4(n_{x_k}+1)-\alpha\left(\alpha \omega
            x^2_k-1\right)\right)\me^{\omega x^2_k} + 2\alpha
            {\omega}^{\frac{3}{2}}x_k(\alpha \omega
            x^2_k-4n_{x_k}-5)\right]H_{n_{x_k}}
    ...
    A similar approach for $y_k$ gives
       \begin{equation}
            ...
            \left(4(n_{y_k}+1)-\alpha\left(\alpha \omega
            y^2_k-1\right)\right)\me^{\omega y^2_k} + 2\alpha
            {\omega}^{\frac{3}{2}}y_k(\alpha \omega
            y^2_k-4n_{y_k}-5)\right]H_{n_{y_k}}
    ...
    Inserting \Autoref{eq:diffs2,eq:diffyk} into \Autoref{eq:nablakth} with
        \begin{equation}
            \begin{aligned}
                ...
                x^2_k-1\right)\right)\me^{\omega x^2_k} + 2\alpha
                {\omega}^{\frac{3}{2}}x_k(\alpha \omega
                x^2_k-4n_{x_k}-5)\right] \\
                + \left[\frac{n_{y_k}\sqrt{\omega}}{y_k}
                \left(4(n_{y_k}+1)-\alpha\left(\alpha \omega
                y^2_k-1\right)\right)\me^{\omega y^2_k} + 2\alpha
                {\omega}^{\frac{3}{2}}y_k(\alpha \omega
                y^2_k-4n_{y_k}-5)\right]
            \end{aligned}
            \label{eq:Ddef}
        \end{equation}
    gives
