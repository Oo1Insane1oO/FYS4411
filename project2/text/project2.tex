...
\newcommand{\adj}[1]{\text{adj}\left(#1\right)}
    ...
    the product rule and the hermiticity of $\psi_T$, we have
        \begin{align}
            ...
            &= 2\left(\ecp{\frac{1}{\abs{\psi_T}^2}\prd{\alpha}[\psi_T][2]E_L} + \ecp{\frac{1}{\psi_T}E_L\prd{\alpha}[\psi_T][2]} + 2\ecp{\frac{1}{\psi_T}\prd{\alpha}[\psi_T]\prd{\alpha}[E_L]} + \ecp{\prd{\alpha}[E_L][2]}\right)
