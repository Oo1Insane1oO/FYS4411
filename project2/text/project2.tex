    ...
    The final expression for the elements in the Hessen matrix is thus
        \begin{equation}
            \begin{aligned}
                ...
                \ecp{E_L\left(\suml{i}{N}r^2_i\right)^2} -
                \frac{8\omega}{2}\ecp{E_L\suml{i}{N}r^2_i}
                \ecp{\suml{i}{N}r^2_i} - \frac{\omega^2}{2}\ecp{E_L}
                \ecp{\left(\suml{i}{N}r^2_i\right)^2} +
                2\omega^2\ecp{E_L}\ecp{\suml{i}{N}r^2_i}^2 \\
            \end{aligned}
        \end{equation}
