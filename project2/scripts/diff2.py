...
diff2PsiTx1 = sy.simplify(sy.Derivate(psiT, x1, 2))
diff2PsiTy1 = sy.simplify(sy.Derivate(psiT, y1, 2))
diff2PsiTx2 = sy.simplify(sy.Derivate(psiT, x2, 2))
diff2PsiTy2 = sy.simplify(sy.Derivate(psiT, y2, 2))
